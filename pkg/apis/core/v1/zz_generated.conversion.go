...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_LinuxIDMapping_To_core_LinuxIDMapping,
		Convert_core_LinuxIDMapping_To_v1_LinuxIDMapping,
...
func autoConvert_v1_LinuxIDMapping_To_core_LinuxIDMapping(in *v1.LinuxIDMapping, out *core.LinuxIDMapping, s conversion.Scope) error {
	out.HostId = (*uint32)(unsafe.Pointer(in.HostId))
	out.ContainerId = (*uint32)(unsafe.Pointer(in.ContainerId))
	out.Size_ = in.Size_
	return nil
}

// Convert_v1_LinuxIDMapping_To_core_LinuxIDMapping is an autogenerated conversion function.
func Convert_v1_LinuxIDMapping_To_core_LinuxIDMapping(in *v1.LinuxIDMapping, out *core.LinuxIDMapping, s conversion.Scope) error {
	return autoConvert_v1_LinuxIDMapping_To_core_LinuxIDMapping(in, out, s)
}

func autoConvert_core_LinuxIDMapping_To_v1_LinuxIDMapping(in *core.LinuxIDMapping, out *v1.LinuxIDMapping, s conversion.Scope) error {
	out.HostId = (*uint32)(unsafe.Pointer(in.HostId))
	out.ContainerId = (*uint32)(unsafe.Pointer(in.ContainerId))
	out.Size_ = in.Size_
	return nil
...
// Convert_core_LinuxIDMapping_To_v1_LinuxIDMapping is an autogenerated conversion function.
func Convert_core_LinuxIDMapping_To_v1_LinuxIDMapping(in *core.LinuxIDMapping, out *v1.LinuxIDMapping, s conversion.Scope) error {
	return autoConvert_core_LinuxIDMapping_To_v1_LinuxIDMapping(in, out, s)
}
...
func autoConvert_v1_PodSecurityContext_To_core_PodSecurityContext(in *v1.PodSecurityContext, out *core.PodSecurityContext, s conversion.Scope) error {
	...
	out.UIDMappings = *(*[]core.LinuxIDMapping)(unsafe.Pointer(&in.UIDMappings))
	out.GIDMappings = *(*[]core.LinuxIDMapping)(unsafe.Pointer(&in.GIDMappings))
	return nil
}
...
func autoConvert_core_PodSecurityContext_To_v1_PodSecurityContext(in *core.PodSecurityContext, out *v1.PodSecurityContext, s conversion.Scope) error {
	...
	out.SupplementalGroups = *(*[]int64)(unsafe.Pointer(&in.SupplementalGroups))
	out.FSGroup = (*int64)(unsafe.Pointer(in.FSGroup))
	out.UIDMappings = *(*[]v1.LinuxIDMapping)(unsafe.Pointer(&in.UIDMappings))
	out.GIDMappings = *(*[]v1.LinuxIDMapping)(unsafe.Pointer(&in.GIDMappings))
	return nil
}
